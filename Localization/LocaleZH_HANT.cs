    ...
    public sealed class LocaleZH_HANT : IDictionarySource
    {
            ...
            Dictionary<string, int> indexCounts)
        {
            ...
            return new Dictionary<string, string>
            {
                ...
                { WaitStatus.KeyStatusNotLoaded, "狀態未載入。" },
                { WaitStatus.KeyNoCityLoaded, "未載入城市。" },
                { WaitStatus.KeyNoStopsFound, "未找到站點。" },

                { WaitStatus.KeyStatusLine, "{0} 等待 | 平均 {1} | 最差 {2} | {3}" },
                { WaitStatus.KeyStatusLateSkipped, "{0} 今日遲到" },
                { WaitStatus.KeyStatusSkipOff, "跳過 OFF" },

                { WaitStatus.KeyStatusOverviewLine, "{0} 遊客/月 | {1} 市民/月 | 更新 {2}" },
                { WaitStatus.KeyStatusRunSoonerLine, "{0}" },
                { WaitStatus.KeyStatusRunSoonerOff, "提早奔跑OFF" },

                // Stats-to-log report strings
                { WaitStatus.KeyReportNoCityLoaded, "[BBoard] 已請求統計報告，但未載入城市。" },
                { WaitStatus.KeyReportTitle, "統計寫入日誌快照 - Better Boarding" },
                ...
                { WaitStatus.KeyReportLateBoardersSkipped, "今天跳過的遲到乘客: {0}" },
                { WaitStatus.KeyReportWorstStopNone, "最差站點：無，目前沒有等待乘客。" },
                { WaitStatus.KeyReportWorstStopAverageWait, "最差站點平均等待: {0}" },
                { WaitStatus.KeyReportWorstStopName, "最差站點名稱: {0}" },
                { WaitStatus.KeyReportWorstStopEntity, "最差站點實體: {0}" },
                { WaitStatus.KeyReportWorstWaypointEntity, "最差 waypoint 實體: {0}" },
                { WaitStatus.KeyReportWorstLineHint, "最差路線提示: {0}" },
                { WaitStatus.KeyReportWorstLineEntity, "最差路線實體: {0}" },
